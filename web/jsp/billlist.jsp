      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
		  ...
		  <p>
			  <c:if test="${page.currentPage!=1}">
				  <a href="${pageContext.request.contextPath }/jsp/bill.do?method=query&currentPage=1">首页</a>
				  <a href="${pageContext.request.contextPath }/jsp/bill.do?method=query&currentPage=${page.currentPage-1}">上一页</a>
			  </c:if>
			  <c:if test="${page.currentPage!=page.pageCount}">
				  <a href="${pageContext.request.contextPath }/jsp/bill.do?method=query&currentPage=${page.currentPage+1}">下一页</a>
				  <a href="${pageContext.request.contextPath }/jsp/bill.do?method=query&currentPage=${page.pageCount}">末页</a>
			  </c:if>
			  <form method="post" action="${pageContext.request.contextPath }/jsp/bill.do">
		  			...
		  			/
		  			<input type="text" value="${page.pageCount}" disabled>
